...
<head>
    ...
    <meta name="description" content="Registrati come tutor, costruisci una tua reputazione e iniziare a guadagnare">
...
<?php injectNavbar("signup");?>
    ...
    <div id="container-sign-up">
        <form id="Signup-form" action="sign-up-tutor-server.php" method="post" autocomplete="off">
            <h1>BENVENUTO!</h1>
            <h2>Diventa un tutor ed inizia a guadagnare</h2>
            <div id="credential-form-container">
                <div id="progress-bar-container">
                    ...
                    <fieldset class="form-page">
                        <legend  class="signup-group-legend">Dettagli tutor</legend>
                        ...
                        <div class="Signup-field" id="sub-selector"> 
                            <div class="select-menu">
                                <label for = "sel-abbonamento" aria-label = "Scegli un abbonamento">Scegli un'abbonamento:</label>
                                <select id = "sel-abbonamento" name = "sel-abbonamento" form="Signup-form">
                                    <option value="mensile">Mensile - 10&euro; al mese</option>
                                    <option value="semestrale">Semestrale - 50&euro; ogni 6 mesi</option>
                                    <option value="annuale">Annuale - 90&euro; all'anno</option>
                                </select>
                            </div>
                        </div>
                    </div>
